...
public static class ItemList
{
    ...
    public static Resource Redstone = new("Redstone", null);
    public static Resource Emerald = new("Emerald", isprites.Emerald);
    public static Resource Netherite = new("Netherite Ingot", null);
    public static Resource Obsidian = new("Obsidian", null);

    public static Resource RottenFlesh = new("Rotten Flesh", null);
